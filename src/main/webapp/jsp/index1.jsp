...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
    <h5 class="my-0 mr-md-auto font-weight-normal"><a href="${pageContext.request.contextPath}/jsp/index1.jsp"></a>资源仓库</h5>
...
<div >
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4">欢迎！${user.realname}</h1>
        <p class="lead">快速进入</p>
    </div>
...
<script>
    ...
    btn1.onclick=function () {
        window.location.href = "${pageContext.request.contextPath}/jsp/image_index.jsp"
    };
    btn2.onclick=function () {
        window.location.href = "${pageContext.request.contextPath}/jsp/music_index.jsp"
    };
    btn3.onclick=function () {
        window.location.href = "${pageContext.request.contextPath}/jsp/video_index.jsp"
    }
</script>
</body>
</html>
